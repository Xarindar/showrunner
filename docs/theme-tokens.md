...
This is intentional. Exposing every token to clients would turn the admin into a site builder and make designs easier to break.
...
4. Test public pages and admin pages.
5. Update this document with the intended use case.
