...
(function () {
  ...
  function css() {
    return [
      ...
      ".sr-switch{align-items:center;cursor:pointer;display:inline-grid;gap:var(--sr-space-2);grid-template-columns:minmax(0,1fr) auto;min-height:30px;position:relative}.sr-switch-copy{display:grid;gap:2px;min-width:0}.sr-switch-copy span{color:var(--sr-muted);font-size:.82rem;line-height:1.35}.sr-switch-input{cursor:inherit;height:100%;inset:0;margin:0;opacity:0;position:absolute;width:100%;z-index:1}.sr-switch-track{align-items:center;background:color-mix(in srgb,var(--sr-muted) 14%,var(--sr-bg));border:1px solid color-mix(in srgb,var(--sr-muted) 32%,var(--sr-border));border-radius:999px;display:inline-flex;flex:none;height:24px;padding:2px;width:44px}.sr-switch-thumb{background:var(--sr-bg);border-radius:999px;box-shadow:0 1px 2px rgba(15,23,42,.18);display:block;height:18px;transition:transform .16s ease;width:18px}.sr-switch-input:checked + .sr-switch-track{background:var(--sr-accent);border-color:var(--sr-accent)}.sr-switch-input:checked + .sr-switch-track .sr-switch-thumb{transform:translateX(20px)}.sr-switch-input:focus-visible + .sr-switch-track{box-shadow:0 0 0 3px color-mix(in srgb,var(--sr-accent),transparent 70%)}",
  ...
  class ShowrunnerBooking extends HTMLElement {
    ...
    renderBookingForm(service) {
      ...
      var policy = service && service.policyText
        ? "<label class='sr-switch sr-field-full'><span class='sr-switch-copy'><strong>Policy</strong><span>" + escapeHtml(service.policyText) + "</span></span><input class='sr-switch-input' role='switch' name='policyAccepted' type='checkbox'" + (service.requirePolicy ? " required" : "") + "><span aria-hidden='true' class='sr-switch-track'><span class='sr-switch-thumb'></span></span></label>"
        : "";
...
(function () {
  ...
  function css() {
    return [
      ":host{display:block;font-family:var(--font-sans,Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif);}",
      ".sr-form{--sr-accent:var(--color-brand,#0f766e);--sr-bg:var(--color-surface,#ffffff);--sr-border:var(--color-border,#d5d9df);--sr-muted:var(--color-muted,#64748b);--sr-panel:var(--color-surface-sunken,#f8fafc);--sr-text:var(--color-text,#111827);--sr-radius:var(--radius-card,8px);--sr-space-2:var(--space-2,8px);--sr-space-3:var(--space-3,12px);--sr-space-4:var(--space-4,16px);--sr-control:var(--control-height,42px);background:var(--sr-bg);border:1px solid var(--sr-border);border-radius:var(--sr-radius);color:var(--sr-text);display:grid;gap:var(--sr-space-3);max-width:680px;min-height:280px;padding:var(--sr-space-4)}.sr-field{display:grid;gap:6px}label{font-size:.82rem;font-weight:650}fieldset{border:0;margin:0;padding:0}legend{color:var(--sr-muted);font-size:.86rem;font-weight:700;margin-bottom:6px}input,select,textarea{background:var(--sr-bg);border:1px solid var(--sr-border);border-radius:calc(var(--sr-radius) - 2px);box-sizing:border-box;color:var(--sr-text);font:inherit;min-height:var(--sr-control);padding:8px 10px;width:100%;}input[type=checkbox],input[type=radio]{min-height:auto;padding:0;width:auto}.sr-switch{align-items:center;cursor:pointer;display:inline-grid;gap:var(--sr-space-2);grid-template-columns:minmax(0,1fr) auto;min-height:30px;position:relative}.sr-switch-copy{display:grid;gap:2px;min-width:0}.sr-switch-copy span{color:var(--sr-muted);font-size:.82rem;line-height:1.35}.sr-switch-input{cursor:inherit;height:100%;inset:0;margin:0;opacity:0;position:absolute;width:100%;z-index:1}.sr-switch-track{align-items:center;background:color-mix(in srgb,var(--sr-muted) 14%,var(--sr-bg));border:1px solid color-mix(in srgb,var(--sr-muted) 32%,var(--sr-border));border-radius:999px;display:inline-flex;flex:none;height:24px;padding:2px;width:44px}.sr-switch-thumb{background:var(--sr-bg);border-radius:999px;box-shadow:0 1px 2px rgba(15,23,42,.18);display:block;height:18px;transition:transform .16s ease;width:18px}.sr-switch-input:checked + .sr-switch-track{background:var(--sr-accent);border-color:var(--sr-accent)}.sr-switch-input:checked + .sr-switch-track .sr-switch-thumb{transform:translateX(20px)}.sr-switch-input:focus-visible + .sr-switch-track{box-shadow:0 0 0 3px color-mix(in srgb,var(--sr-accent),transparent 70%)}textarea{min-height:90px}.sr-error,.sr-success,.sr-empty{border-radius:calc(var(--sr-radius) - 2px);min-height:48px;padding:10px}.sr-error{background:color-mix(in srgb,var(--color-danger,#991b1b) 8%,var(--sr-bg));color:var(--color-danger,#991b1b)}.sr-success{background:color-mix(in srgb,var(--color-success,#065f46) 9%,var(--sr-bg));color:var(--color-success,#065f46)}.sr-empty{background:var(--sr-panel);color:var(--sr-muted)}button{background:var(--sr-accent);border:0;border-radius:calc(var(--sr-radius) - 2px);color:#fff;cursor:pointer;font:inherit;font-weight:700;min-height:var(--sr-control);padding:9px 12px}button[disabled]{cursor:not-allowed;opacity:.6}.sr-secondary{background:var(--sr-panel);color:var(--sr-text)}.sr-honeypot{height:0;left:-10000px;opacity:0;overflow:hidden;position:absolute;width:0}.sr-actions{align-items:center;display:flex;flex-wrap:wrap;gap:var(--sr-space-2);justify-content:space-between}.sr-step{background:var(--sr-panel);border-radius:999px;color:var(--sr-muted);font-size:.78rem;font-weight:750;padding:4px 9px}.sr-choice{align-items:center;display:flex;gap:8px}.sr-signature-panel{display:grid;gap:8px}.sr-signature-pad{background:var(--sr-panel);border:1px solid var(--sr-border);border-radius:calc(var(--sr-radius) - 2px);height:150px;touch-action:none;width:100%}.sr-help{color:var(--sr-muted);font-size:.82rem}"
    ].join("");
  }
  ...
  function fieldHtml(field) {
    ...
    if (field.type === "CHECKBOX") return wrapField(field, "<div class='sr-field'><label class='sr-switch'><span class='sr-switch-copy'><strong>" + escapeHtml(field.label) + (field.isRequired ? " *" : "") + "</strong></span><input class='sr-switch-input' role='switch' name='" + escapeHtml(field.inputName) + "' type='checkbox'" + required + helpAttrs + "><span aria-hidden='true' class='sr-switch-track'><span class='sr-switch-thumb'></span></span></label>" + helpHtml(field) + "</div>");
    ...
    if (field.type === "SIGNATURE") {
      return wrapField(field, "<div class='sr-field' data-signature-field='" + escapeHtml(field.inputName) + "' data-signature-required='" + (field.isRequired ? "true" : "false") + "'>" +
        ...
        helpHtml(field) +
        "<label class='sr-switch'><span class='sr-switch-copy'><span>" + escapeHtml(signatureConsentStatement) + "</span></span><input class='sr-switch-input' role='switch' data-signature-consent name='" + escapeHtml(field.inputName) + "-consent' type='checkbox'" + required + "><span aria-hidden='true' class='sr-switch-track'><span class='sr-switch-thumb'></span></span></label>" +
      "</div>");
    }
