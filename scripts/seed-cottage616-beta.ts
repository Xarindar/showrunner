...
async function main() {
  ...
  if (adminPassword) {
    ...
    await prisma.adminUser.upsert({
      ...
      update: { tenantId: DEFAULT_TENANT_ID, passwordHash, role: AdminRole.OWNER },
      create: { email: adminEmail, tenantId: DEFAULT_TENANT_ID, passwordHash, role: AdminRole.OWNER }
    });
  }
