...
export const cottageContentManifest = validateManifest({
  ...
  blocks: [configuredBlock("business-info", "business", []), ...["home", "hive", "booking", "vendors"].map(page => configuredBlock(`${page}-seo`, "seo", [page], { label: `${page === "home" ? "Homepage" : page === "hive" ? "The Hive" : page === "booking" ? "Booking" : "Vendors"} SEO` }))],
});
