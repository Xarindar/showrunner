...
} from "@/modules/content/hero-presentation";
...
export function contentProfilesToJson(profiles: Record<ContentProfileKey, ContentProfileDraft>, existing?: Prisma.JsonValue) {
  return {
