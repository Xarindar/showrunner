...
] satisfies DashboardCardDefinition[];
...
export function normalizeDashboardCardPlacements(
  ...
  for (const item of source) {
    ...
    normalized.push({
      ...
      size: normalizeDashboardCardSize(cardId, record.size)
    });
...
export function dashboardCardSizeLabel(size: DashboardCardSize) {
...
export function cardSizeColumnSpan(size: DashboardCardSize) {
  if (size === "lg") return 2;
  return 1;
}
